...
# ...
    ...
    def run_pool(self, processes=4):
        ...
        self.right_sim_table = Parallel(n_jobs=processes, verbose=1)([delayed(self.calc_cossim)(target_u_id, target_user_eval) for target_u_id, target_user_eval in enumerate(self.eval_table)])
